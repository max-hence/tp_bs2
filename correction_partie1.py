...
from graph_tool.all import graph_draw, load_graph, betweenness, label_out_component
SIZE = 400
V_SIZE = SIZE/10
E_PWIDTH = V_SIZE/4
...
v4 = g.vertex(4)
print(id[v4]) # quand on fait verted(4) on a le 5e ...
...
# Question 6 : Afficher que la composante connexe associée au sommet 4
l = label_out_component(g, g.vertex(4))
print(l.a)
